...
public class LicenseService {
  ...
  public List<License> getLicenseByOrganization(String organizationId) throws TimeoutException {
    ...
    log.info("getLicenseByOrganizationID correlation id: " +
  ...
  private List<License> buildFallbackLicenseList(String organizationId, Throwable t) {
    ...
    return List.of(new License().withId("000000-00-000000").withOrganizationId(organizationId)
        .withProductName("Sorry, no licensing informatino currently available"));
  }
